...
>
> Chatwork全ルームと長期スケジュールファイル（tasks/long-term-schedule.md）を収集・分析し、「PM分析レポート」フォーマットで返してください。
...
{strategist が除外推奨したタスクと理由}

* ////

日次業務サマリー — {last_date}〜{TODAY前日}
> 作成: {作成日時} JST
